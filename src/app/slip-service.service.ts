...
export class SlipServiceService {
  ...
  public debitusingslip(debit:slipTransactions){    
    return this.http.put("http://localhost:2002/transactions/debitUsingSlip",debit,{responseType: 'text'});
  }
  public creditusingslip(credit:slipTransactions){   
    return this.http.put("http://localhost:2002/transactions/creditUsingSlip",credit,{responseType: 'text'});
  }
